...
namespace eval ::optrace {
  variable script "C:/Abba/counter/counter.runs/impl_1/button_counter.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir C:/Abba/counter/counter.cache/wt [current_project]
  set_property parent.project_path C:/Abba/counter/counter.xpr [current_project]
  set_property ip_output_repo C:/Abba/counter/counter.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet C:/Abba/counter/counter.runs/synth_1/button_counter.dcp
...
OPTRACE "link_design" START { }
  link_design -top button_counter -part xc7k70tfbv676-1 
...
OPTRACE "Post-Place Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force button_counter_physopt.dcp
...
OPTRACE "route_design reports" START { REPORT }
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -report_unconstrained -file button_counter_timing_summary_routed.rpt -pb button_counter_timing_summary_routed.pb -rpx button_counter_timing_summary_routed.rpx -warn_on_violation "
